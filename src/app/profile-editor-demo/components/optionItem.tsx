...
const OptionItemCom = (props: any) => {
  ...
  const [attributesTree, setAttributesTree] = useState<any[]>(
  ...
  return (
    <div className="flex">
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <div className="flex mt-2 w-full items-center">
            ...
            <Select
              ...
              options={(optionItemMsg.options || []).map(
                (v: Record<string, any>) => ({
                  value: v.code,
                  label: `${v.name}`,
                }),
        ...
        {!optionItemMsg._isTopLevel && (
          <div
            ...
            className="flex items-center cursor-pointer mt-2 text-grey-normal"
          >
      ...
      <div
        className="text-grey-normal mt-3 relative flex"
        style={{
          height: `calc(${optionItemMsg?.attributeMsg?.valueType == "IMAGE" ? imageBoxHeight : stringBoxHeight}px - 40px)`,
        }}
      >
        ...
        <div className="ml-2 flex items-center flex-col justify-center">
          ...
          >
            <PlusCircleFilled style={{ color: "#918f8f" }} />
            <span className="ml-1" style={{ width: "123px" }}>
              Add sub option
            </span>
          </div>
        </div>
