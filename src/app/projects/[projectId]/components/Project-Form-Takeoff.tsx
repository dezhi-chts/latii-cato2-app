...
// 定义组件的对外接口类型
type ProjectFormTakeoffHandle = {
  isValidForm: () => boolean;
};

interface ProjectFormTakeoffProps {
  projectSettings: any;
...
const ProjectFormTakeoff = forwardRef<ProjectFormTakeoffHandle, ProjectFormTakeoffProps>(({ projectSettings, setProjectSettings, OCRFieldName = '', showOCRIcon = false, handleAddOCRBox }, ref) => {
  const isValidForm = () => {
    let isValid = true;
...
ProjectFormTakeoff.displayName = 'ProjectFormTakeoff';

export default ProjectFormTakeoff;
