...
const TakeOffCard = ({ takeOff, fetchTakeOffs }: any) => {
  ...
  return (
    <div className="flex rounded-3xl border border-primaryN50 items-center relative text-sm gap-4 p-9 w-full justify-between hover:bg-primaryN10">
      <Link
        href={linkHref}
        className="flex flex-1 gap-4 items-center pointer-events-auto"
      >
        {takeOffData.status === 2 && (
          <div className="absolute top-6 bg-forumBlue-normal text-white px-3 rounded-full">
            Analyzed
          </div>
        )}
      ...
      <div className="flex border border-primaryN30 rounded-2xl text-sm text-center pointer-events-auto">
        <div className="px-4 py-3 w-20">
          ...
          <p className="text-xxs text-grey-normal"># Items</p>
        </div>
        ...
        <div className="px-4 py-3 w-20">
          ...
          <p className="text-xxs text-grey-normal">Products</p>
        </div>
      </div>
      ...
      <div className="flex gap-4 pointer-events-none">
        <div
          className={`flex w-72 ${
            takeOff?.project_files?.length > 1
              ? "justify-evenly"
              : "justify-center"
          } pointer-events-auto`}
        >
