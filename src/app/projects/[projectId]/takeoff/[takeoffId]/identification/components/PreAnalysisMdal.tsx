...
const PreAnalysisMdal = ({ isOpen, closeModal, handleAnalysis }: any) => {
  const columns = [
    {
      title: (
    ...
    >
      <div className="flex flex-col gap-3 font-nunito">
        ...
        <div className="my-4 text-xs">
          Once the pre-analysis begins, changing the prompt template will return
          you to the Page Labeling Step.
        </div>
        <div className="flex flex-row justify-end gap-2">
          <Button
            className="custom-default-btn !w-[110px]"
            onClick={closeModal}
          >
            Prompt Editing
          </Button>
          <Button
            className="custom-primary-btn !w-[74px]"
