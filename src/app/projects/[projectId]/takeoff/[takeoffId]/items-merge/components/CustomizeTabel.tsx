        ...
        render: (text: any, record: any, index: number) => {
          return (
            <div className="flex justify-center items-center">
              <span className="px-[6px] py-[1px] text-xs text-white bg-forumBlue-normal rounded">
                {index + 1}
              </span>
            </div>
          );
                      ...
                      return prev.map((item: any) => {
                        if (item.id === record.id) {
                          if (item.selectFields.includes(value)) {
                            ...
                            return {
                              ...item,
                              selectFields: item.selectFields.filter(
                            ...
                            return {
                              ...item,
                              selectFields: [...item.selectFields, value],
                            };
                          }
                        }
                        return { ...item };
                ...
                <p
                  ...
                  style={{
                    backgroundColor: fieldSelected
                      ? colorList.forumBlue - normal + "10"
                      : "transparent",
                    borderColor: fieldSelected
