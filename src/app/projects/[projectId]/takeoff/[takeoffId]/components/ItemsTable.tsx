    ...
    const defaultColumns = [
        {
            ...
            render: (_: any, record: any) => {
                return <div className="flex items-center justify-center">
                    <div className="w-[16px] h-[16px] rounded-full bg-transparent border border-basicLightGray"
                        style={{
                            backgroundColor: record.state === "active" ? "green" : "transparent",
                        }}
                    ></div>
                </div> 
            },
            ...
            <div className="flex justify-between w-full">
                ...
                >
                    <div className="flex items-center justify-center">
                        ...
                        <span className="ml-1 px-[6px] py-[1px] rounded-2xl inline-block text-white text-sm"
                            style={{
                                backgroundColor: repeatGroups > 0 ? colorList.basicGray : colorList.accentGreen,
                            }}
                        >
                            {repeatGroups}
                        </span>
