...
const ImageSelector = ({
  ...
  onValueChange,
  handleImageCurrentSelectedMode,
}: IImageSelectorProps) => {
  ...
  useEffect(() => {
    ...
    if (item?.image?.drawing_image_url) {
      checkImageUrl(item.image.drawing_image_url).then((valid) => {
        setImageValid(valid);
      });
    } else {
      setImageValid(false);
    ...
    if (item?.image?.extract_image_url) {
      checkImageUrl(item.image.extract_image_url).then((valid) => {
  ...
  const onHandleDrawingItem = (e: any) => {
    ...
    if (e.key == "system") {
      ...
      drawingUseItem.item_type.selected_value =
        drawingUseItem.units[0].product.selected_value;
    ...
    <Spin spinning={isLoading}>
      {item.frame_material?.selected_value && (
        <div
          ...
          className="w-full h-80 rounded-xl border border-dashed border-primaryN50 flex items-center justify-center gap-2 text-xs relative"
        >
          {item.image &&
            ...
            item.image.current_selected_mode == "upload" && (
              <Popconfirm
                ...
                cancelText="No"
              >
                <DeleteOutlined className="absolute left-3 top-3 text-lg cursor-pointer text-gray-500" />
              </Popconfirm>
            )}
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div className="flex flex-col items-center gap-1 group cursor-pointer">
              ...
              >
                ...
                {item.image && item.image.drawing_image_url && imageValid && (
                  <Badge
                    dot
                    color="#2A845A"
              ...
              {/* </Dropdown> */}
              <p className="text-grey-normal">Draw</p>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M3.25208 11.3848L3.25478 12.7181C3.25549 13.0717 3.39665 13.4106 3.6472 13.6601C3.89776 13.9097 4.23718 14.0494 4.5908 14.0487L12.5908 14.0326C12.9444 14.0319 13.2833 13.8907 13.5328 13.6401C13.7823 13.3896 13.9221 13.0502 13.9214 12.6965L13.9187 11.3632"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M5.2413 6.04817L8.56789 2.70811L11.908 6.0347"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M8.56789 2.70703L8.58406 10.707"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <p className="text-grey-normal">Upload</p>
            </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <path
                        d="M3 4.5C3 4.10218 3.15804 3.72064 3.43934 3.43934C3.72064 3.15804 4.10218 3 4.5 3H13.5C13.8978 3 14.2794 3.15804 14.5607 3.43934C14.842 3.72064 15 4.10218 15 4.5V13.5C15 13.8978 14.842 14.2794 14.5607 14.5607C14.2794 14.842 13.8978 15 13.5 15H4.5C4.10218 15 3.72064 14.842 3.43934 14.5607C3.15804 14.2794 3 13.8978 3 13.5V4.5Z"
                        stroke="currentColor"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      ...
                      />
                      <path
                        d="M3 8.99987L5.25 6.74987C5.946 6.08012 6.804 6.08012 7.5 6.74987L10.5 9.74987"
                        stroke="currentColor"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M9.75 8.99987L11.25 7.49987C11.946 6.83012 12.804 6.83012 13.5 7.49987L15 8.99987"
                        stroke="currentColor"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M10.5 5.25H10.5075"
                        stroke="currentColor"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                ...
                <p className="text-grey-normal">Extract</p>
              </div>
            )}
          </div>
