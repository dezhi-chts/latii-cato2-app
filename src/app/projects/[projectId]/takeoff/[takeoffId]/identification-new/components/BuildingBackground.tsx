...
const CircleProgressView = ({ size = 78 }: { size?: number }) => {
  return (
    <div className={`w-[${size}px] h-[${size}px] flex items-center justify-center relative`}>
...
const BuildingBackground = ({ step }: { step: string }) => {
  const stepMap: any = {
    "page-label": {
      title: "Processing your request...",
      subTitle: "We are preparing your content for page labeling. \nThis should only take a moment.",
      description: "",
    },
    "page-merge": {
      title: "Preparing merge workspace...",
      subTitle: "Moving to the multi-file workspace to review and merge your data.",
      description: "",
    },
    "page-takeoff": {
  ...
  return (
    <div className="h-screen w-screen z-[5000] fixed top-0 left-0 overflow-hidden flex justify-center items-center bg-white">
      ...
      <div className="w-[608px] flex flex-col gap-5 items-center">
        ...
        <div className="text-[22px] text-forumBlue-normal">{title}</div>
        <div className="text-base text-center whitespace-pre-line">{subTitle}</div>
        {description && (
